...
export default function Back() {
    ...
    return (
        <button className='flex text-sm md:text-base items-center gap-[10px] mb-[64px] lg:mb-[90px] shadow-md px-6 py-[6px] rounded-sm dark:bg-[#2B3844]' onClick={() => { router.back() }}>
            <svg
                width={20}
                height={20}
                viewBox="0 0 20 20"
