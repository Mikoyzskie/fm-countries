  ...
  return (
    <div className="maxWidth mt-12 pb-[45px]">
      <div className="flex md:items-center justify-between mb-12 flex-col md:flex-row gap-10 px-4 md:px-0">
        <div className="shadow-md md:max-w-[480px] w-full py-[18px] px-8 flex items-center gap-6 rounded-[5px]">
          ...
          <form className="w-full">
            <input type="text" name="country" placeholder="Search for a country…" className="outline-none text-xs md:text-sm w-full" />
          </form>
        </div>
        <Filter />
      </div>
